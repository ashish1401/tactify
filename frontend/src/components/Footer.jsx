...
const Footer = () => {
    return (
        <footer className=" z-10 bg-gradient-to-l from-black to-[#1F0061] font-sora text-white pt-20 ">
                ...
                <div className="-mx-4 flex flex-wrap justify-center align-middle">
                    <div className="w-full  sm:w-2/3 lg:w-3/12">
                        <div className="mb-10 w-full text-center">
                            <Link to="/" className="mb-6 inline-block max-w-[160px]  ">
                                <img src="./images/rocket-white.png" alt="logo" className=" max-w-full " />
                            </Link>
                            <p className="text-body-color mb-7 text-base font-bold">
                                Tactify. <br />Think Data , Think Tactify
                            </p>
                    ...
                    <div className="w-full px-4 sm:w-1/2 text-center content-center lg:w-3/12">
                        <div className="mb-3 w-full mx-auto">
                            ...
                            <p className="text-body-color text-base">&copy; 2023 Tactify</p>
                        </div>
                    </div>
