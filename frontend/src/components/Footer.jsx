...
const Footer = () => {
    return (
        <footer class=" z-10 bg-gradient-to-l from-black to-[#1F0061] font-sora text-white pt-20 ">
                ...
                <div class="-mx-4 flex flex-wrap justify-center align-middle">
                    <div class="w-full  sm:w-2/3 lg:w-3/12">
                        <div class="mb-10 w-full text-center">
                            <Link to="/" class="mb-6 inline-block max-w-[160px]">
                                <img src="./images/rocket.png" alt="logo" class="max-w-full" />
                            </Link>
                    ...
                    <div class="w-full px-4 sm:w-1/2 text-center content-center lg:w-3/12">
                        <div class="mb-3 w-full mx-auto">
                            ...
                            <p class="text-body-color text-base">&copy; 2023 Tactify</p>
                        </div>
                    </div>
